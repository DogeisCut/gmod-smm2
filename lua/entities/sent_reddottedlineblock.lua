...
ENT.IconOverride		=	"materials/supergarrysmaker/entities/reddottedlineblock.jpg"
...
hook.Add("PhysgunDrop", "ReddottedlineblockStop", function(ply, ent)
	if ent:GetClass()=="sent_reddottedlineblock" then
		ent:SnapToGrid()
	end
end )
